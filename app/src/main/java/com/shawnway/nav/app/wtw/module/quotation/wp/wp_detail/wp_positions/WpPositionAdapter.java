...
public class WpPositionAdapter extends BaseQuickAdapter<WpPositionsBean.DataBean.ListBean> {

    private OnLiquidateOnClickListener onLiquidateOnClickListener;

    public WpPositionAdapter() {
        super(R.layout.item_wp_positions, null);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, final WpPositionsBean.DataBean.ListBean listBean) {
        baseViewHolder
