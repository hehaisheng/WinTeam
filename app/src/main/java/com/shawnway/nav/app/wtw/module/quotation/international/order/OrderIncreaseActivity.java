...
public class OrderIncreaseActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected int getLayout() {
        return R.layout.activity_international_order_increase;
    }
    ...
    private void performTrade() {
        ...
        try {
            ...
            jsonObject.put("actionSide", 1);//buy
        ...
        RetrofitClient
                .getInstance()
                .api()
                .order(JsonRequestBody.getInstance().convertJsonContent(jsonObject.toString()))
                .compose(SchedulersCompat.<Response<TradeBean>>applyIoSchedulers())
