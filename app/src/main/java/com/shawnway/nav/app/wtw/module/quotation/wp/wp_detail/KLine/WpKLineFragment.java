...
public class WpKLineFragment extends BaseFragment {
    ...
    public static WpKLineFragment getInstance(QuotationsWPBean bean, int i) {
        WpKLineFragment fragment = new WpKLineFragment();
    ...
    private void initChart() {
       ...
       // ((WpDetailActivity) mContext).wp_ll_kline_data.setVisibility(View.VISIBLE);
        combinedchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                //getActivity().findViewById(R.id.wp_ll_kline_data).setVisibility(View.VISIBLE);
                ...
                ((TextView)linearLayout.findViewById(R.id.wp_kline_closePrice)).setText(String.format("低 %s", candleEntry.getOpen()));
                ((TextView) linearLayout.findViewById(R.id.wp_kline_lowPrice)).setText(String.format("收 %s", candleEntry.getClose()));
            ...
            public void onNothingSelected() {
                //getActivity().findViewById(R.id.wp_ll_kline_data).setVisibility(View.GONE);
