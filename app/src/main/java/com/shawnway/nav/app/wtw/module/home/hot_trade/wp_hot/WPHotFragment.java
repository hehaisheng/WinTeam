package com.shawnway.nav.app.wtw.module.home.hot_trade.wp_hot;
...
public class WPHotFragment extends BaseFragment {

    @BindView(R.id.rv_hot)
    RecyclerView rv_hot_trade;
    private HotTradeHorizontalAdapter hotTradeAdapter;
    ...
    protected void initEventAndData() {
        ...
        hotTradeAdapter.setEmptyView(view);
                ...
                .subscribe(new BaseSubscriber<QuotationsWPBean[]>() {
                    ...
                    public void onSuccess(QuotationsWPBean[] bean) {
                        ...
                        for (int i = 0; i < mGoods.size(); i++) {
                            if (!SPUtils.getInstance(mContext, SPUtils.SP_WP_HOT_SELECTED)
                        ...
                        if (mSelected.size() == 0) {
                            ...
                            hotTradeAdapter.setNewData(mSelected);
                        } else {
                            hotTradeAdapter.setNewData(mSelected);
                        }
                    }
