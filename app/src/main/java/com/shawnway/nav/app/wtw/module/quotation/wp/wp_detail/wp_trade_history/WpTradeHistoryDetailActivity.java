...
public class WpTradeHistoryDetailActivity extends BaseActivity {
    ...
    private WpTradeHistoryBean.DataBean.ListBean bean;

    public static void start(Context context, WpTradeHistoryBean.DataBean.ListBean listBean) {
        Intent starter = new Intent(context, WpTradeHistoryDetailActivity.class);
