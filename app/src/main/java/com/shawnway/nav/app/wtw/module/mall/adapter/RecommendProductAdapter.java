...
public class RecommendProductAdapter extends BaseQuickAdapter<RecommendProductBean.AllProductEntityBean> {
    ...
    @Override
    protected void convert(BaseViewHolder baseViewHolder, final RecommendProductBean.AllProductEntityBean bean) {
        baseViewHolder
