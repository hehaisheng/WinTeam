...
public class WpMoneyHistoryActivity extends BaseActivity<WpMoneyHistoryPresenter> implements WpMoneyHistoryContract.IWpMoneyHistoryView {

    private String token;

    public static void start(Context context) {
        Intent starter = new Intent(context, WpMoneyHistoryActivity.class);
    ...
    private int page = 1;
    private WpMoneyHistoryAdapter adapter;
    ...
    @Override
    protected WpMoneyHistoryPresenter getPresenter() {
        return new WpMoneyHistoryPresenter(mContext, this);
    }
    ...
    protected void initEventAndData() {
        ...
        adapter = new WpMoneyHistoryAdapter();
        ...
        swipe.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                page = 1;
                adapter.setNewData(new ArrayList<WpMoneyHistoryBean.DataBean.ListBean>());
                mPresenter.getWpMoneyHistory(page, token);
            }
        });
        mPresenter.getWpMoneyHistory(page, token);
    ...
    @Override
    public void addWpMoneyHistory(List<WpMoneyHistoryBean.DataBean.ListBean> list) {
