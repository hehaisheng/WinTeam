...
public class MyLineChart extends LineChart {
    ...
    public void setInternationalMarker(MyLeftMarkerView markerLeft, MyRightMarkerView markerRight, MyBottomMarkerView markerBottom, InternationalDataParse minuteHelper) {
        this.myMarkerViewLeft = markerLeft;
        this.myMarkerViewRight = markerRight;
        this.mMyBottomMarkerView = markerBottom;
        this.minuteHelper2 = minuteHelper;
    }
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (xIndex <= deltaX && xIndex <= deltaX * mAnimator.getPhaseX()) {
                ...
                if (minuteHelper != null) {
                    ...
                    yValForXIndex1 = minuteHelper2.getDatas().get(mIndicesToHighlight[i].getXIndex()).cjprice;
                    yValForXIndex2 = minuteHelper2.getDatas().get(mIndicesToHighlight[i].getXIndex()).per;
                    time = minuteHelper2.getDatas().get(mIndicesToHighlight[i].getXIndex()).time.substring(11,16);
