 ...
 * 粤国际微盘产品选中页
 */
public class WPHotTradeActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = WPHotTradeActivity.class.getSimpleName();
    ...
    public static void getInstance(Context context) {
        Intent intent = new Intent(context, WPHotTradeActivity.class);
    ...
    private void saveListDataToSP() {
        for (int i = 0; i < newList.size(); i++) {
            if (newList.get(i).isChecked()) {
                SPUtils.getInstance(mContext, SPUtils.SP_WP_HOT_SELECTED)
