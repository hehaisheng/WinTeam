...
/**
 * Created by Cicinnus on 2016/12/13.
 * 解绑吉交所银行卡
 */
public class UnbindJlWpBankCardActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void getInstance(Context context) {
        Intent intent = new Intent(context, UnbindJlWpBankCardActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getLayout() {
        return R.layout.activity_unbind_jl_wp_bankcard;
    }
