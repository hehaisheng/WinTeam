...
public class HotTradeHorizontalAdapter extends BaseQuickAdapter<QuotationsWPBean> {
    ...
    public HotTradeHorizontalAdapter() {
    ...
    protected void convert(BaseViewHolder baseViewHolder, final QuotationsWPBean quotationsWPBean) {
        ...
        up = chgNum > 0;
        final String productName = SPUtils.getInstance(mContext, SPUtils.SP_WP_HOT_SELECTED)
        ...
        baseViewHolder.convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WpDetailActivity.getInstance(mContext, quotationsWPBean);
            }
        });
