...
public class JlWpTimeLineFragment extends BaseFragment {
    ...
    Runnable run = new Runnable() {
        ...
        public void run() {
            initDatas();
            handler.postDelayed(this, 4 * 10 * 1000);
        }
    };
    private Subscription subscription;

    public static JlWpTimeLineFragment getInstance(QuotationsWPBean bean) {
        JlWpTimeLineFragment fragment = new JlWpTimeLineFragment();
