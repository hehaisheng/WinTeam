...
import com.shawnway.nav.app.wtw.net.RefreshActivity;
import com.shawnway.nav.app.wtw.net.SecurityJsBridgeBundle;
import com.shawnway.nav.app.wtw.net.X5WebViewEventHandler;
...
public class X5WebView extends WebView {
    ...
    private WebChromeClient chromeClient = new WebChromeClient() {
        ...
        public void onShowCustomView(View view, CustomViewCallback customViewCallback) {
            FrameLayout normalView = (FrameLayout) ((Activity) getContext()).findViewById(R.id.web_view);
